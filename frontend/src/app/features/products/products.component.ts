...
@Component({
  ...
  styleUrls: ['./products.component.scss', './products.controls.scss', './products.table.scss'],
...
export class ProductsComponent implements OnInit {
  ...
  openSpecEditor(product: Product) {
    this.specTarget.set(product);
  }
  closeSpecEditor() {
