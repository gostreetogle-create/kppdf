...
2. THE CounterpartyForm SHALL include fields for all Counterparty properties.
...
4. WHEN `ApiService.lookupCounterpartyByInn()` succeeds, THE CounterpartyForm SHALL populate all returned fields without overwriting fields not present in the response.
