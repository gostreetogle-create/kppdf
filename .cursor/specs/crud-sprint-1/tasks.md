...
- [ ] 6. Ручная проверка
  - [ ] 6.1 Проверить навигацию по сайдбару (/, /products, /counterparties, /settings)
  - [ ] 6.2 Проверить мобильный collapse сайдбара < 768px
  - [ ] 6.3 Проверить CRUD контрагентов
  - [ ] 6.4 Проверить DaData lookup (успех, 404, ошибка)
  - [ ] 6.5 Проверить поиск и фильтрацию с debounce
  - [ ] 6.6 Проверить `@media print` скрытие сайдбара
