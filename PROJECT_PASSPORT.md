...
| 2026-04-22 | Settings UX: в разделе «Бэкапы» добавлена кнопка-подсказка «Как восстановить» с командами restore через сервер; дефолт очистки изменён с 7 на 30 дней |
